...
const Navbar = () => {
  ...
  return (
    <>
      <div className="navbar py-3 sticky top-0 z-10 bg-[#d8dfe7] drop-shadow-1">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-compact dropdown-content text-red p-2 shadow bg-base-100 rounded-box w-52"
            >
              {navItems}
            </ul>
          </div>
